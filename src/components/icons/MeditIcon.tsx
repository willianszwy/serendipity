...
export interface MeditIconProps {
  className?: string;
  style?: React.CSSProperties;
}

export const MeditIcon: React.FC<MeditIconProps> = ({ 
  className = "w-6 h-6", 
  style 
}) => {
  return (
    ...
    >
      <path 
        d="m51.68 14c-6.09-7.43-12.79-9.43-16.68-9.43s-11.08.88-15.13 3.17-9.33 7.63-11.37 11.5a23.91 23.91 0 0 0 -2.28 16.54 24.56 24.56 0 0 0 5.42 10.67s-3.5 5.71-.75 8.37a7.71 7.71 0 0 0 9 1.5s3.34 2.84 11.05 3.09 11.33-1.92 16-6 9.12-8.54 10.83-17.38-.01-14.62-6.09-22.03zm-1.21 33.53c-5.29 6.54-10.54 8.75-14 9.79s-10.17.17-12.08-.54a7.57 7.57 0 0 1 -2.92-1.87s3.65-5.56-1.21-9c-4-2.84-7.08-.34-7.08-.34a20.44 20.44 0 0 1 -5.18-11.57c-.54-6.79.79-12.17 3.37-15.62s7.59-11.75 22.59-12c3.54-.06 8.37 1.25 13.21 5.37s8.38 9.74 8.83 15.74-.24 13.51-5.53 20.04zm5-39.21a2.36 2.36 0 0 0 -3-2.95 2.46 2.46 0 0 0 -1.47 3.75c.68.88 4 1.66 4.47-.8z" 
        fill="#1d1d1b"
      />
      <path 
        d="m52.64 6.41a1.59 1.59 0 0 1 2 1 1.38 1.38 0 0 1 -2 1.46c-1.5-.63-.88-2.05 0-2.46z" 
        fill="#85bfe9"
      />
      <path 
        d="m37.59 10.45c1-.73 2.13.54 2.13 1.25s-1.25 1.29-1.92.92a1.29 1.29 0 0 1 -.21-2.17z" 
        fill="#1d1d1b"
      />
      <path 
        d="m46.64 14.66c1-.34 2.58.12 2.54 2.16s-2.79 1.75-3.42.75a1.94 1.94 0 0 1 .88-2.91z" 
        fill="#1d1d1b"
      />
      <path 
        d="m47 15.54a1 1 0 0 1 1.28 1.1c0 1-1.41.89-1.73.38a1 1 0 0 1 .45-1.48z" 
        fill="#e6e4da"
      />
      <path 
        d="m26.43 49.7c1-.34 2.58.12 2.54 2.17s-2.79 1.75-3.42.75a2 2 0 0 1 .88-2.92z" 
        fill="#1d1d1b"
      />
      <path 
        d="m26.76 50.58a1 1 0 0 1 1.24 1.1c0 1-1.41.89-1.73.38a1 1 0 0 1 .49-1.48z" 
        fill="#e6e4da"
      />
      <path 
        d="m14.09 47c1.89-1.17 5-.37 5.88.92s.75 4 .5 4.79a2.64 2.64 0 0 1 -.92 1.29s-1-4-1.33-4.08-.83 0-.83.2 1.37 4.46 1.16 4.63a4.19 4.19 0 0 1 -.62.37s-1.34-4.54-1.59-4.58-.83.38-.7.5 1.54 4.42 1.29 4.46-.67.12-.75 0-1.46-4.25-1.63-4.25-1 .33-.87.5 1.21 3.42 1 3.46a3.86 3.86 0 0 1 -2.68-3.34 4.92 4.92 0 0 1 2.09-4.87z" 
        fill="#ddc07c"
      />
      <path 
        d="m19.26 49.53c.29-.16.88-.25.83-.08s-.09 1.87-.09 1.87a.43.43 0 0 1 -.5-.25 12 12 0 0 1 -.24-1.54z" 
        fill="#1d1d1b"
      />
      <path 
      ...
      />
      <path 
        d="m38.68 16a2.75 2.75 0 0 1 3.12 1c.84 1.29-.41 3.13-.83 3.38s-1.42-.17-1.42-.17-.29-2.09-.55-2.21-1-.12-.83.09.33 1.95.16 1.87a3.28 3.28 0 0 1 -1.16-2.17 2 2 0 0 1 1.51-1.79z" 
        fill="#cbe7f5"
      />
      <g fill="#1d1d1b">
      ...
      <path 
        d="m29.64 26.59c2-.86 7.48-.25 7.45 4.83s-6.54 6.71-8.91 3.87-2.72-6.92 1.46-8.7z" 
        fill="#fab900"
      />
    </svg>
  );
