...
export const MonthView: React.FC<MonthViewProps> = ({
  ...
  return (
    <div 
      className={`min-h-screen font-borel ${className}`} 
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex items-center mb-6">
          ...
          <div className="flex-1">
            <h2 className="text-5xl font-borel" style={{ color: COLORS.primaryText }}>
              {monthName} {year}
            </h2>
            {totalEntries > 0 && (
              <p className="text-lg opacity-75 mt-1 font-borel" style={{ color: COLORS.primaryText }}>
